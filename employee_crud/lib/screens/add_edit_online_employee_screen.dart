...
//   void initstate() {
//     super.initState();
//     if (widget.employee != null) _nameController.text = widget.employee!.name;
...
//           context,
//         ).showSnackBar(SnackBar(content: Text('Erroe: $e')));
//       }
//     }
//     }
//     @override
...
//     validator: (value) =>
//     value!.isEmpty ? 'Enter a disignation' :null,
//     ),
//
//
//     TextFormField(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Address'),
                      validator: (value) =>
                      value!.isEmpty ? 'Enter a Address' : null,
                    ),
                    TextFormField(
                      controller: _dobController,
